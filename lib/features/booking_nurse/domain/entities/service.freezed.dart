...
mixin _$Service {
 ...
 String get id; String get key; double get basePrice; bool get active; int get sortOrder;
...
@override
int get hashCode => Object.hash(runtimeType,id,key,basePrice,active,sortOrder);

@override
String toString() {
  return 'Service(id: $id, key: $key, basePrice: $basePrice, active: $active, sortOrder: $sortOrder)';
}
...
@useResult
$Res call({
 String id, String key, double basePrice, bool active, int sortOrder
});
...
/// Create a copy of Service
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? key = null,Object? basePrice = null,Object? active = null,Object? sortOrder = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String key,  double basePrice,  bool active,  int sortOrder)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Service() when $default != null:
return $default(_that.id,_that.key,_that.basePrice,_that.active,_that.sortOrder);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String key,  double basePrice,  bool active,  int sortOrder)  $default,) {final _that = this;
switch (_that) {
case _Service():
return $default(_that.id,_that.key,_that.basePrice,_that.active,_that.sortOrder);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String key,  double basePrice,  bool active,  int sortOrder)?  $default,) {final _that = this;
switch (_that) {
case _Service() when $default != null:
return $default(_that.id,_that.key,_that.basePrice,_that.active,_that.sortOrder);case _:
  return null;
...
class _Service implements Service {
  const _Service({required this.id, required this.key, required this.basePrice, this.active = true, this.sortOrder = 0});
...
/// Create a copy of Service
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? key = null,Object? basePrice = null,Object? active = null,Object? sortOrder = null,}) {
